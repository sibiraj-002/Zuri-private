...
const PresidentialSuiteBengaluruBanner = () => {
    const BannerImg = {
        backgroundImage: `url('/bengaluru/room-suites/presidential_suite_banner.jpg')`,
        height: 466,
...
export default PresidentialSuiteBengaluruBanner