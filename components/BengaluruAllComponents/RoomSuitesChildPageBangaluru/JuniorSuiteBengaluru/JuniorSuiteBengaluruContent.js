...
const JuniorSuiteBengaluruContent = () => {
    const AmitiesBg = {
        background: '#cab17b'
    }
    return (
        <>
            <Container className='p-md-0 p-2 text-center'>
                <Col className='d-flex flex-column align-items-center '>
                    ...
                    <h6 className='py-2 text-center'>JUNIOR SUITES, BENGALURU</h6>
                    <p>
                        Not just a hotel suite in Bengaluru, these luxurious suites have a private bar, an elegant powder room, an inviting rain-shower and a bathtub. A large, generous sixty-four square metre suite to stay and relax in. The Junior Suite at the <Link href="/hotels-in-bengaluru/" className='text-decoration-none text-black'>Zuri Whitefield</Link> offers the perfect setting allowing you to prepare for your business deal or meeting, so you step out as fresh as your next big business idea.
                    </p>
                </Col>
...
export default JuniorSuiteBengaluruContent