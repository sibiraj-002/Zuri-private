...
const ZuriRoomBengaluruContent = () => {
    const AmitiesBg = {
        background: '#cab17b'
    }
        ...
        <>
            <Container className='p-md-0 p-2 text-center'>
                <Col className='d-flex flex-column align-items-center '>
                    ...
                    <h6 className='py-2 text-center'>ZURI ROOM, BENGALURU</h6>
                    <p>
                        The Zuri comprises of over 90 Zuri rooms, each measuring 32 square metres, replete with opulent black and silver decor and lavish furnishing. The luxurious 5-fixture bathroom includes a spacious bathtub, to soak in at the end of a tiring day. All these room-amenities make the Zuri one of the best 5-star hotels in Whitefield, Bengaluru.
                    </p>

                    <p>
                        Note: The guests can Check-in at 1pm and check-out at 11am based on the duration of their stay.
                    </p>
                    <p>
...
export default ZuriRoomBengaluruContent