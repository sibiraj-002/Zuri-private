...
const WaterFallGoaBanner = () => {
    const BannerImg = {
        backgroundImage: `url('/goa/dining/waterfall_cafe_banner.jpg')`,
        height: 466,
        backgroundSize: 'cover'
    }
    return (
        <Container className='p-0pb-lg-5 pb-3' style={{}}>
...
export default WaterFallGoaBanner