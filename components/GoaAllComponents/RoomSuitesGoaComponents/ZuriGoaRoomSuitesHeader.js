...
const ZuriGoaRoomSuitesHeader = () => {
    return (
        <>
            <Container className='custom-kumarkom-menu-container'>

                <h3 className='text-center py-md-2 text-custom-grey'>THE ZURI WHITE SANDS, GOA RESORT & CASINO</h3>
...
export default ZuriGoaRoomSuitesHeader