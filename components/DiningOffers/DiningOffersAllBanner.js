...
const DiningOffersAllBanner = () => {
    const BannerImg = {
        backgroundImage: `url('/offers/dining_offers_banner.jpg')`,
        height: 500,
        ...
        <>
            <Container className='custom-kumarkom-menu-container' style={{}}>
                ...
                <h3 className='text-center py-md-4 text-custom-grey'>
                    DINING OFFERS AT ZURI HOTELS & RESORTS
                </h3>
...
export default DiningOffersAllBanner