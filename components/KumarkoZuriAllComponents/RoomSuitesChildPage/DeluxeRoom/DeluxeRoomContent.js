    ...
    return (
        <>
            <Container className='p-0 py-4 text-center'>
                ...
                <Col className='px-5'>
                    <p>
                        Located on the first floor, the 42 square meter Zuri Deluxe room in Kumarakom is an epitome of luxury. Featuring a spacious balcony overlooking a beautiful lagoon, it offers spectacular views of the surrounding areas, while cradling you in absolute comfort.
                    </p>
...
export default DeluxeRoomContent