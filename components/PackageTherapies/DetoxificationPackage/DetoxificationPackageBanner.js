...
const DetoxificationPackageBanner = () => {
    const BannerImg = {
        backgroundImage: `url('/kumarkom/offers/detoxifiaction_package_banner.jpg')`,
        height: 460,
    ...
    return (
        <Container className='custom-kumarkom-menu-container' style={{}}>
            ...
            <Col className='text-center pb-3'>
                <h3 className='text-custom-grey'>DETOXIFICATION PROGRAMME</h3>
            </Col>
...
export default DetoxificationPackageBanner