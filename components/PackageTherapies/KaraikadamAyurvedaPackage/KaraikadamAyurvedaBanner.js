...
const KaraikadamAyurvedaBanner = () => {
    const BannerImg = {
        backgroundImage: `url('/kumarkom/offers/karaikadam_banner.png')`,
        height: 460,
    ...
    return (
        <Container className='custom-kumarkom-menu-container' style={{}}>
            ...
            <Col className='text-center pb-3'>
                <h3 className='text-custom-grey'>KARKIDAKAM AYURVEDA TREATMENT</h3>
            </Col>
...
export default KaraikadamAyurvedaBanner